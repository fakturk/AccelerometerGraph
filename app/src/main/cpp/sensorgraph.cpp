...
class sensorgraph {
 ...
 public:
    ...
    float getAccDataX()
    {
        ...
        return sensorDataFilter.x;
    }
    float getAccDataY()
    {


        return sensorDataFilter.y;
    }
    float getAccDataZ()
    {


        return sensorDataFilter.z;
    }
...
JNIEXPORT void JNICALL
    Java_netlab_fakturk_accelerometergraph_AccelerometerGraphJNI_init(
    ...
    JNIEXPORT void JNICALL
    Java_netlab_fakturk_accelerometergraph_AccelerometerGraphJNI_surfaceCreated(JNIEnv *env, jclass type) {
        (void)env;
        (void)type;
    ...
    JNIEXPORT void JNICALL
    Java_netlab_fakturk_accelerometergraph_AccelerometerGraphJNI_surfaceChanged(
    ...
    JNIEXPORT void JNICALL
    Java_netlab_fakturk_accelerometergraph_AccelerometerGraphJNI_drawFrame(
    ...
    JNIEXPORT void JNICALL
    Java_netlab_fakturk_accelerometergraph_AccelerometerGraphJNI_pause(
            JNIEnv *env, jclass type) {
        (void)env;
        (void)type;
        gSensorGraph.pause();
    ...
    JNIEXPORT void JNICALL
    Java_netlab_fakturk_accelerometergraph_AccelerometerGraphJNI_resume(
            JNIEnv *env, jclass type) {
        (void)env;
        (void)type;
        gSensorGraph.resume();
...
Java_netlab_fakturk_accelerometergraph_AccelerometerGraphJNI_getAccDataX(
        JNIEnv *env, jclass type) {
    (void)env;
    (void)type;
    return gSensorGraph.getAccDataX();
}

JNIEXPORT float JNICALL
Java_netlab_fakturk_accelerometergraph_AccelerometerGraphJNI_getAccDataY(
        JNIEnv *env, jclass type) {
    (void)env;
    (void)type;
    return gSensorGraph.getAccDataY();
}

JNIEXPORT float JNICALL
Java_netlab_fakturk_accelerometergraph_AccelerometerGraphJNI_getAccDataZ(
        JNIEnv *env, jclass type) {
    (void)env;
    (void)type;
    return gSensorGraph.getAccDataZ();
}
